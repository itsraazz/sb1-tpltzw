...
export default function AddNoticeModal({ isOpen, onClose, onSubmit }: AddNoticeModalProps) {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    const noticeData = {
      ...formData,
      imageUrl: previews[0] || '', // Use the first preview as the notice thumbnail
    };
    onSubmit(noticeData, selectedFiles);
    onClose();
    setFormData({
      title: '',
      content: '',
